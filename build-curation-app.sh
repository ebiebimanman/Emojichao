...
plutil -replace CFBundleDisplayName -string "EmojiShortcut 絵文字仕分け" "$app_dir/Contents/Info.plist"
plutil -replace CFBundleExecutable -string "EmojiCuration" "$app_dir/Contents/Info.plist"
plutil -replace CFBundleName -string "EmojiShortcut Curation" "$app_dir/Contents/Info.plist"
plutil -replace CFBundleIdentifier -string "com.ebiebimanman.emoji-shortcut.curation" "$app_dir/Contents/Info.plist"
